...
{
    static final int MAXCOURSE=100; static final int MAXPERYEAR=10;
...
static void modify(Course c[],int k,int n)throws IOException/*function to modify course parameters:the course array,the index of course to be modified and total no of courses*/
    ...
    static void DisplayMenu()/*Displays main menu*/
    {
        ...
        System.out.println("Press 2 to display all courses(within 1 year)");
    ...
    static void createnewcourse(Course c[],int n)throws IOException/*Creates new course parameters:Course array,no_of_courses present*/
    {
        BufferedReader br=new BufferedReader(new InputStreamReader(System.in));
        String s1;
    ...
    static void writefile(Course c[],int no_of_courses,int no_in_year)throws IOException//write the records to a text file
    {
        File f2 = new File("CourseManagement.txt");
                ...
                writer2.write(Integer.toString(no_in_year)+System.getProperty( "line.separator" ));
    ...
    public static  boolean withinYear(Date inputDate)//checks if date is within a year of today's date
    {
...
GregorianCalendar oneYearAgoTodayAtMidnight = new GregorianCalendar(calToday.get(Calendar.YEAR) - 1, calToday.get(Calendar.MONTH), calToday.get(Calendar.DATE));
    ...
    public static void main(String args[])throws IOException 
    {
        ...
        BufferedReader br=new BufferedReader(new InputStreamReader(System.in));
        int no_of_courses=0;int no_in_year=0;
        ...
        vg=Integer.parseInt(br.readLine());}
            ...
            if(vg==1)
            {
                ...
                no_in_year=Integer.parseInt(rd.nextLine());
                for(i=0,o=0;i<n3;++i)
                {
                     flag=1;
        ...
        while(flagg==1)
        {
            ...
            switch(ch)
            {
                ...
                if(no_in_year==MAXPERYEAR)
                {System.out.println("Maximum number of Courses for a year reached.Cannot create anymore Courses.Exiting to menu");break;}
                createnewcourse(c,no_of_courses);
                ++no_of_courses;
                ...
                if(no_of_courses==0)
                {
                    System.out.println("There are currently no saved courses within 1 year ");break;
                }
                        System.out.println("Displaying all courses within 1 year:");
                    ...
                    { 
                    	...
                    	if(withinYear(c[i].start_date)==false)
                    	{continue;}
                    	++j;
