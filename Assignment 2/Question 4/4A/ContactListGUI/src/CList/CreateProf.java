...
public class CreateProf extends JFrame {
	 ...
	 * Create the frame.
	 */
	public CreateProf(FullContactList L) {
		setTitle("Create new professional friend");
		...
		btnDone .addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				int flag=1;
			      ...
			      if(s2.length()>100)
			      {flag=0;JOptionPane.showMessageDialog(null,"Must be less than 100 characters","Input Error",JOptionPane.PLAIN_MESSAGE);dispose();}
