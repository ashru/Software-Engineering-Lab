...
public class DisplayallInst extends JFrame {
	 ...
	 * Create the frame.
	 */
	public DisplayallInst(Course c) {
...
this.setVisible(true);
		...
		for(int i=0;i<5;++i){
			...
			if(i>c.no_of_instructors-1)
			{
				...
				p[0][i]=c.instructors[i].name;
				p[1][i]=c.instructors[i].address;
				p[2][i]=c.instructors[i].Department;
				p[3][i]=Long.toString(c.instructors[i].mobile_no);
				p[4][i]=c.instructors[i].email_id;
			}
